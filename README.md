...
| US006-T3 | Crear vista para seguimiento del impacto de prevención | Crear interfaz para mostrar el impacto de las acciones preventivas en la salud de los cultivos.                               | 7                      |
...
| ---------- | ----------------- | ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ |
| 1          | US001             | Explorar la Página de Inicio              | Como visitante, quiero explorar la página de inicio para obtener una visión general del sitio web y sus secciones.                                                           | 1                                    |
| 2          | US002             | Ver Información de Productos/Servicios    | Como visitante, quiero ver información detallada sobre los productos o servicios ofrecidos.                                                                                  | 1                                    |
| 3          | US003             | Contactar al Equipo de Ventas             | Como visitante interesado, quiero encontrar una forma de contactar al equipo de ventas.                                                                                      | 1                                    |
| 4          | US004             | Explorar Testimonios o Casos de Éxito     | Como visitante, quiero leer testimonios o casos de éxito para evaluar la confiabilidad del sitio.                                                                            | 1                                    |
| 5          | US005             | Definir Objetivos de Rendimiento          | Como agricultor, quiero definir objetivos de rendimiento para mis cultivos para poder medir y mejorar mi productividad.                                                      | 3                                    |
| 6          | US006             | Adaptar Estrategia de Cultivo             | Como agricultor, quiero adaptar mi estrategia de cultivo según los cambios en el entorno o las condiciones climáticas para poder maximizar la productividad de mis cultivos. | 3                                    |
| 7          | US007             | Seguimiento de Actividades Agrícolas      | Como agricultor, quiero realizar un seguimiento detallado de las actividades agrícolas diarias para poder analizar y optimizar mis procesos.                                 | 2                                    |
| 8          | US008             | Monitoreo de Calidad de Productos         | Como agricultor, quiero monitorear la calidad de mis productos para asegurarme de que cumplen con los estándares requeridos.                                                 | 2                                    |
| 9          | US009             | Acceso a Mejores Prácticas Agrícolas      | Como agricultor, quiero tener acceso a información actualizada sobre las mejores prácticas agrícolas para mejorar la calidad de mis productos.                               | 1                                    |
| 10         | US010             | Predicción y Prevención de Amenazas       | Como agricultor, quiero predecir y prevenir posibles amenazas a mis cultivos para reducir las pérdidas.                                                                      | 3                                    |
| 11         | US011             | Recepción de Alertas Climáticas           | Como agricultor, quiero recibir alertas sobre condiciones climáticas adversas para poder tomar medidas preventivas y proteger mis cultivos.                                  | 2                                    |
| 12         | US012             | Asesoramiento en Objetivos de Rendimiento | Como consultor agrícola, quiero asesorar a los agricultores en la definición de objetivos de rendimiento para sus cultivos.                                                  | 2                                    |
| 13         | US013             | Asesoramiento en Estrategias de Cultivo   | Como consultor agrícola, quiero asesorar a los agricultores en la adaptación de su estrategia de cultivo según los cambios en el entorno o las condiciones climáticas.       | 3                                    |
| 14         | US014             | Asesoramiento en Control de Calidad       | Como consultor agrícola, quiero asesorar a los agricultores en el monitoreo de la calidad de sus productos.                                                                  | 1                                    |
| 15         | US015             | Asesoramiento en Prevención de Amenazas   | Como consultor agrícola, quiero asesorar a los agricultores en la predicción y prevención de posibles amenazas a sus cultivos.                                               | 3                                    |
...
| Sprint 1 Goal                      | En este sprint se tiene como objetivo el desarrollo de la landing page y el despliegue de la misma. Además, durante las diversas reuniones del equipo se determinó el contenido y diseño de la landing page, el cual fue implementado en Figma. Una vez concluido el sprint, la landing debe estar desplegada en GitHub Pages y los usuarios podrán acceder a la misma a través del link.                                                                                                                                                                                                                          |
| Sprint 1 Velocity                  | 3                                                                                                                                                                                                                   |
...
![Sprint3 Deployment](assets/Sprint3Deployment1.png)

![Sprint3 Deployment](assets/Sprint3Deployment2.png)

Se logró desplegar la última versión de la aplicación web en Netlify.

Link de la web app desplegada: https://grow-with-me.netlify.app/

#### 5.2.3.8 Team Collaboration Insights during Sprint

- Repositorio Backend:

![Sprint3 Insights](assets/Sprint3Insight1.png)

- Repositorio Frontend:

![Sprint3 Insights](assets/Sprint3Insight2.png)
...
- Segmento Agricultores:
  - ¿Qué te gustaría ver en una aplicación web?
  - ¿Qué es útil para ti como usuario agricultor de nuestra aplicación?
  - ¿Consideras que nuestra app ayudaría a tus cultivos a crecer?
  - ¿Consideras que nuestra app ayudaría a tu empresa?
  - ¿Te gustaría recomendar alguna función? Crítica

- Segmento Consultores:
  - ¿Qué te gustaría ver en una aplicación web?
  - ¿Qué es útil para ti como usuario Consutor de nuestra aplicación?
  - ¿Consideras que nuestra app ayudaría a tu carrera como consultor a crecer?
  - ¿Te gustaría recomendar alguna función? Crítica
...
Link a la Landing Page en Netlify: https://si729-cup-of-tech-landing.netlify.app/
